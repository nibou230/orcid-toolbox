...
with tab_summary:
    ...
    if works_count > 0 and 'publication-year' in works_df.columns:
        st.bar_chart(works_df['publication-year'].value_counts().sort_index(), height=400, color="#51A27E")
    else:
    ...
    if works_count > 0 and 'type' in works_df.columns:
        ...
        st.bar_chart(mapped_work_types.value_counts(), horizontal=True, sort=False, height=400, color="#51A27E")
    else:
        st.warning(_("Aucune donnée de publication disponible pour générer le graphique."))
